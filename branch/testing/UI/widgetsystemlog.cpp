...
void WidgetSystemLog::appendLog(QString message, LogSeverity::Severity severity)
{
	if (ui->actionToggleTimestamp->isChecked())
	{
		...
		case LogSeverity::Information:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightInformation).arg(skinSettings.logColorInformation).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Security:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightSecurity).arg(skinSettings.logColorSecurity).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Notice:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightNotice).arg(skinSettings.logColorNotice).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Debug:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightDebug).arg(skinSettings.logColorDebug).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Warning:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightWarning).arg(skinSettings.logColorWarning).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Error:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightError).arg(skinSettings.logColorError).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Critical:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3: %4</span>").arg(skinSettings.logWeightCritical).arg(skinSettings.logColorCritical).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		}
	} else {
		switch (severity)
		{
		case LogSeverity::Information:
			ui->textEditSystemLog->append(QString("<span style=\" font-size:8pt; %1 %2\">%3:</span>").arg(skinSettings.logWeightInformation).arg(skinSettings.logColorInformation).arg(timeStamp.toString("hh:mm:ss.zzz")).arg(message));
			break;
		case LogSeverity::Security:
