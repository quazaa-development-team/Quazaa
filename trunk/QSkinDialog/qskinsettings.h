...
public:
	...
	QString chatMessagesWeightNormal;
	QColor chatMessagesColorHighlighted;
	QString chatMessagesWeightHighlighted;
	QColor chatMessagesColorServer;
	QString chatMessagesWeightServer;
	QColor chatMessagesColorTopics;
	QString chatMessagesWeightTopics;
	QColor chatMessagesColorNotices;
	QString chatMessagesWeightNotices;
	QColor chatMessagesColorActions;
	QString chatMessagesWeightActions;
