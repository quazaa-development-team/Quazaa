...
void CSkinSettings::setGenericSkin()
{
	...
	sidebarBackground += "QTabBar::tab { color: white; background-color: transparent; border: 1px solid transparent; border-radius: 3px; margin: 2px; min-width: 8ex; padding: 3px; font-weight: bold; } ";
	...
	sidebarTaskHeader = "QToolButton { border-image: none; background-color: #6E99C6; border: 0px solid transparent; border-radius: 3px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; color: white; font-size: 16px; font-weight: bold; } ";
...
void CSkinSettings::setLunaskin()
{
	...
	sidebarTaskHeader="QToolButton { border-image: url(:/Resource/Luna/taskHeader.png); border: 2px solid transparent; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; color: white; font-size: 16px; font-weight: bold; } QToolButton:!checked { border-image: url(:/Resource/Luna/taskHeaderOff.png); } QToolButton:hover { color: lightgrey; }";
	addSearchButton="QToolButton { border-image: url(:/Resource/Luna/addSearch.png); border: 2px solid transparent; color: black; font-size: 16px; font-weight: bold; } QToolButton:hover { color: rgb(98, 98, 98); }";
	...
	taskHeader="QToolButton { border-image: url(:/Resource/Luna/unclickableTaskHeader.png); color: black; font-size: 16px; font-weight: bold; }";
...
void CSkinSettings::setAeroSkin()
{
	...
	sidebarTaskBackground = "QFrame { border-image: none; border: 0px solid transparent; background-color: transparent; color: rgb(16,21,59); }";
