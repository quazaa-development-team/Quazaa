...
public:
    ...
    IrcChannelStackView* currentWidget() const;
    IrcChannelStackView* connectionWidget(IrcConnection* connection) const;
...
private:
    struct Private {
        ...
        QHash<IrcConnection*, IrcChannelStackView*> connectionWidgets;
    } d;
};
