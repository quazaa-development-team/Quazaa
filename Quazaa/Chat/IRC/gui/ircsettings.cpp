...
IrcSettings::IrcSettings() : maxBlockCount(-1), timeStamp(true), layout("tree"), stripNicks(true)
{
#ifdef Q_OS_MAC
...
IrcSettings::operator QVariant() const
{
	return QVariant::fromValue(*this);
}

bool IrcSettings::operator==(const IrcSettings& other) const
{
