...
QString MessageFormatter::formatMessage(IrcMessage* message, IrcUserListModel* userModel) const
{
    QString formatted;
    d.highlight = false;
...
void MessageFormatter::applySettings()
{

    IrcPalette palette;
    palette.setColorName(IrcPalette::White, quazaaSettings.Chat.Colors.value(IrcColorType::White));
    palette.setColorName(IrcPalette::Black, quazaaSettings.Chat.Colors.value(IrcColorType::Black));
    palette.setColorName(IrcPalette::Blue, quazaaSettings.Chat.Colors.value(IrcColorType::Blue));
    palette.setColorName(IrcPalette::Green, quazaaSettings.Chat.Colors.value(IrcColorType::Green));
    palette.setColorName(IrcPalette::Red, quazaaSettings.Chat.Colors.value(IrcColorType::Red));
    palette.setColorName(IrcPalette::Brown, quazaaSettings.Chat.Colors.value(IrcColorType::Brown));
    palette.setColorName(IrcPalette::Purple, quazaaSettings.Chat.Colors.value(IrcColorType::Purple));
    palette.setColorName(IrcPalette::Orange, quazaaSettings.Chat.Colors.value(IrcColorType::Orange));
    palette.setColorName(IrcPalette::Yellow, quazaaSettings.Chat.Colors.value(IrcColorType::Yellow));
    palette.setColorName(IrcPalette::LightGreen, quazaaSettings.Chat.Colors.value(IrcColorType::LightGreen));
    palette.setColorName(IrcPalette::Cyan, quazaaSettings.Chat.Colors.value(IrcColorType::Cyan));
    palette.setColorName(IrcPalette::LightCyan, quazaaSettings.Chat.Colors.value(IrcColorType::LightCyan));
    palette.setColorName(IrcPalette::LightBlue, quazaaSettings.Chat.Colors.value(IrcColorType::LightBlue));
    palette.setColorName(IrcPalette::Pink, quazaaSettings.Chat.Colors.value(IrcColorType::Pink));
    palette.setColorName(IrcPalette::Gray, quazaaSettings.Chat.Colors.value(IrcColorType::Gray));
    palette.setColorName(IrcPalette::LightGray, quazaaSettings.Chat.Colors.value(IrcColorType::LightGray));
